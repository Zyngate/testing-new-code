...
def generate_task_name(description: str) -> str:
    """Generate a short task name. Delegates to task_utils for consistency."""
    from services.task_utils import generate_task_name as _generate
    return _generate(description)
